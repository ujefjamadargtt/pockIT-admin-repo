...
@Component({
  selector: 'app-map-email-to-child-customer',
  templateUrl: './map-email-to-child-customer.component.html',
  styleUrls: ['./map-email-to-child-customer.component.css']
})
export class MapEmailToChildCustomerComponent {
  isSpinning;
  pageIndex = 1;
  pageSize = 10;
  ...
  save() {
    ...
    const dataToSave: any = {
      CUSTOMER_ID: this.data.ID, // Replace with actual value
