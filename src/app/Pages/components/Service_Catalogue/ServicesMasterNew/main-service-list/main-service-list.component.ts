...
@Component({
  ...
  styleUrls: ['./main-service-list.component.css'],
  providers: [DatePipe],
})
export class MainServiceListComponent implements OnInit {
  ...
  drawerData1: ServiceCatMasterDataNew = new ServiceCatMasterDataNew();
  searchText: string = '';
