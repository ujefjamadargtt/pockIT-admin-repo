...
@Component({
  selector: 'app-addnew-service-for-b2-blist',
  templateUrl: './addnew-service-for-b2-blist.component.html',
  styleUrls: ['./addnew-service-for-b2-blist.component.css'],
  providers: [DatePipe],
})
export class AddnewServiceForB2BListComponent implements OnInit {
  drawerVisible: boolean = false;
  drawerData: ServiceCatMasterDataNewB2b = new ServiceCatMasterDataNewB2b();
  drawerVisibleDesigner: boolean = false;
  dataDesigner: ServiceCatMasterDataNewB2b = new ServiceCatMasterDataNewB2b();
  drawerVisible1: boolean = false;
  drawerTitle1!: string;
  drawerTitleDesigner!: string;
  drawerData1: ServiceCatMasterDataNewB2b = new ServiceCatMasterDataNewB2b();
  searchText: string = '';
  ...
  @Input() drawerVisibleB2bCust: boolean = false;
  @Input() parentSerIdB2bCust: any;
  @Input() drawerCloseSubserviceB2bCust: any = Function;
  ...
  search(reset: boolean = false) {
    ...
    this.api
      .getServiceItem(
        ...
        this.sortKey,
        sort,
        likeQuery + ' AND PARENT_ID=0 AND IS_FOR_B2B = 1 AND CUSTOMER_ID = ' + this.parentSerIdB2bCust + this.filterQuery
      )
      .subscribe(
        (data) => {
          if (data['code'] == 200) {
  ...
  add(): void {
    ...
    this.drawerData = new ServiceCatMasterDataNewB2b();
    this.drawerVisible = true;
    this.custid = this.parentSerIdB2bCust;
  }
  drawerClose(): void {
    this.dataList = [];
    this.pageIndex = 1;
  ...
  parentSerId: any;
  sername: any;
  addSubService(event: any, name: any, data: ServiceCatMasterDataNewB2b): void {
    this.drawerTitle1 = 'Manage Sub Services';
    this.pageIndex = 1;
    this.searchText = '';
    this.drawerData1 = Object.assign({}, data);
    this.parentSerId = event;
    this.sername = name;
  ...
  edit(data: ServiceCatMasterDataNewB2b): void {
  ...
  opendetailsDrawer(data: ServiceCatMasterDataNewB2b) {
    this.pageIndex = 1;
    this.searchText = '';
  ...
  drawerDataMaped: ServiceCatMasterDataNewB2b = new ServiceCatMasterDataNewB2b();
  ...
  filterFields: any[] = [
    ...
    },
    {
      ...
      placeholder: 'Select Is Having Sub Service?',
    },
    {
      key: 'IS_EXPRESS',
