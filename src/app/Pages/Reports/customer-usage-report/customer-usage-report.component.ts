...
@Component({
  selector: 'app-customer-usage-report',
  templateUrl: './customer-usage-report.component.html',
  styleUrls: ['./customer-usage-report.component.css']
})
export class CustomerUsageReportComponent {
  formTitle = 'Customer Usage Summary Report';
  excelData: any = [];
  ...
  openfilter() {
    this.drawerTitle = 'Customer Usage Summary Report Filter';
    this.drawerFilterVisible = true;
    this.editButton = 'N';
    this.FILTER_NAME = '';
    this.EditQueryData = [];
  ...
  drawerData: any;
  viewCustomerUsage(data: any) {
    this.drawerData = data;
    this.drawerTitle = data.CUSTOMER_NAME + "'s Usage Summary Report";
    ...
    if (this.excelData.length > 0) {
      for (var i = 0; i < this.excelData.length; i++) {
        ...
        obj1['Customer Name'] = this.excelData[i]['CUSTOMER_NAME']
          ...
          : '-';
        obj1['Total Debited Amount'] = this.excelData[i]['TOTAL_DEBITED_AMOUNT']
          ? this.excelData[i]['TOTAL_DEBITED_AMOUNT']
          : '-';
        arry1.push(Object.assign({}, obj1));
        if (i == this.excelData.length - 1) {
          this._exportService.exportExcel(
            arry1,
            'Customer Usage Summary Report ' +
