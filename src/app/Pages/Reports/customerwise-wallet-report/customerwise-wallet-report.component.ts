...
@Component({
  selector: 'app-customerwise-wallet-report',
  templateUrl: './customerwise-wallet-report.component.html',
  styleUrls: ['./customerwise-wallet-report.component.css']
})
export class CustomerwiseWalletReportComponent {

  formTitle = 'Customer Wise Wallet Report';
  excelData: any = [];
  ...
  openfilter() {
    this.drawerTitle = 'Customer Wise Wallet Report Filter';
    this.drawerFilterVisible = true;
    this.editButton = 'N';
    this.FILTER_NAME = '';
    this.EditQueryData = [];
  ...
  viewTransactionhistory(data: any) {
    ...
    this.drawerTitle = data.CUSTOMER_NAME + "'s Transaction Report";
    ...
    if (this.excelData.length > 0) {
      for (var i = 0; i < this.excelData.length; i++) {
        ...
        obj1['Customer Name'] = this.excelData[i]['CUSTOMER_NAME']
          ...
          : '-';
        obj1['Available Balance'] = this.excelData[i]['AVAILABLE_BALANCE']
          ? this.excelData[i]['AVAILABLE_BALANCE']
          : '-';
        obj1['Used Amount'] = this.excelData[i]['USED_AMOUNT']
          ? this.excelData[i]['USED_AMOUNT']
          : '-';
