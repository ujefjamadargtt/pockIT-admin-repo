...
@Component({
  selector: 'app-typewise-transaction-report',
  templateUrl: './typewise-transaction-report.component.html',
  styleUrls: ['./typewise-transaction-report.component.css']
})
export class TypewiseTransactionReportComponent {

  formTitle = 'Type Wise Transaction Report';
  excelData: any = [];
  ...
  openfilter() {
    this.drawerTitle = 'Type Wise Transaction Report Filter';
    this.drawerFilterVisible = true;
    this.editButton = 'N';
    this.FILTER_NAME = '';
    this.EditQueryData = [];
