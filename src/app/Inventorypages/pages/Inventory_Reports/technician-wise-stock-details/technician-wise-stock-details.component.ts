...
@Component({
  ...
  styleUrls: ['./technician-wise-stock-details.component.css'],
})
export class TechnicianWiseStockDetailsComponent implements OnInit {
  filterGroups: any[] = [
    {
      operator: 'AND',
      conditions: [
      ...
      for (var i = 0; i < this.excelData.length; i++) {
        ...
        if (i == this.excelData.length - 1) {
          this._exportService.exportExcel(
            arry1,
            'Technician Wise Item Stock Details Report ' +
